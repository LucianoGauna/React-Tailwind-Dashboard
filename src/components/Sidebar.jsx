...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <aside className={`bg-gradient-to-br from-[#20323c] to-[#28404d] fixed ${isSidebarOpen ? "translate-x-0" : "-translate-x-80" } inset-0 z-20 my-4 ml-4 w-72 text-white rounded-xl transition-transform duration-300 lg:translate-x-0 font-bold`}>
